...
# 绘制训练过程曲线
# python analyze_logs_my.py plot_curve ../checkpoints/resnet18_8xb32_in1k_fruit30_20230215_152343.log.json --keys loss

# python analyze_logs_my.py plot_curve ../checkpoints/resnet18_8xb32_in1k_fruit30_20230215_152343.log.json --keys  accuracy_top-1 accuracy_top-5

# 绘制训练的迭代时间
# python analyze_logs_my.py cal_train_time ../checkpoints/resnet18_8xb32_in1k_fruit30_20230215_152343.log.json
